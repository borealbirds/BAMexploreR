...
# NO AOI provided
tmap_mode("plot")
subUnitsv4_results <- mapBCR("v4_demo") 
...
#--No year with v5
#v5
lol <- getlayerNM(spp, "v5_demo", destfile = "C:/temp/BAMNM", ext = "can10")

# --No ext 
#v5
lol <- getlayerNM(spp, "v5_demo", year = "2015", destfile = "C:/temp/BAMNM")
#v4
lol <- getlayerNM(spp, "v4_demo", destfile = "C:/temp/BAMNM")
