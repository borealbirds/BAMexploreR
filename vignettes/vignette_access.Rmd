...
`BAMexploreR` is a package for downloading and analyzing bird species data from the BAM National Model v4 and v51. Functions in the package perform the following tasks:
