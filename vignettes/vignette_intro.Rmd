...
This reference table can be used to understand the different predictors that went into the BAM landbird density models, including a description and source for each, as well as the categories they are grouped into for some of the habitat relationship functions.
...
var_meta |> 
  dplyr::select(version, predictor, definition, category) |> 
  head(3)
```
