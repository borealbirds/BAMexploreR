...
### Model versions
Two versions of the BAM National Models are available in `BAMExploreR`. 
...
| **Temporal resolution**                                            | Predictions for 2017                                 | Predictions at five-year intervals from 1985 to 2020 |
| **Modelled sub-regions**                                           | Bird conservation region (BCR) and province          | Updated BCRs and country |
| **Environmental covariates**                                       | Landcover, biomass, climate                          | Time-matched variables for vegetation biomass, human disturbance, and annual climate |
...
```{r, fig.width=8, message=FALSE, warning=FALSE, echo=FALSE, out.width='100%'}
library(tmap)
bam_map_bcr("v5")
```
