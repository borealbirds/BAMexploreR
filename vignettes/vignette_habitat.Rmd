...
Now we're just looking at one species, Canada Warbler, but if we include multiple species in our `species` argument, we get summarized statistics. Let's add some more species and see what we get.
...
It looks like vegetation structure is pretty important! There is a metadata table for the model predictors stored in the package. Let's check out what goes into the biomass class.
