...
aoi_importance <- bam_predictor_importance(species = cosewic_v5, bcr = bcraoi_v5, group = "bcr", version = "v5", plot=FALSE)
...
bam_predictor_barchart(species = spp_v5, bcr = bcraoi_v5, groups=c("spp", "predictor_class"), version = "v5", plot=TRUE)
```
...
bam_predictor_barchart(species = spp_v5, bcr = bcraoi_v5, groups=c("bcr", "predictor_class"), version = "v5", plot=TRUE)
```
...
bam_predictor_barchart(species = spp_v5, bcr = bcraoi_v5, groups=c("predictor", "spp"), version = "v5", plot=TRUE)
...
# Create plot of predictor importance for each species grouped by predictor class
bam_predictor_barchart(species = spp_v5, bcr = bcraoi_v5, groups=c("predictor", "spp"), version = "v5", plot=FALSE)
