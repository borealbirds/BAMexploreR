...
bam_predictor_barchart(species = spp_v5, bcr = bcraoi_v5, groups=c("spp", "var_class"), version = "v5", plot=TRUE)
```
...
bam_predictor_barchart(species = spp_v5, bcr = bcraoi_v5, groups=c("bcr", "var_class"), version = "v5", plot=TRUE)
```
...
bam_predictor_barchart(species = spp_v5, bcr = bcraoi_v5, groups=c("var", "spp"), version = "v5", plot=TRUE)
...
# Create plot of predictor importance for each species grouped by predictor class
bam_predictor_barchart(species = spp_v5, bcr = bcraoi_v5, groups=c("var", "spp"), version = "v5", plot=FALSE)
