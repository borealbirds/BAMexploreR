...
bam_predictors_v5 |>
  group_by(spp) |>
  slice_max(order_by = sum_influence, n = 2) |> 
  ungroup() |> 
...
# BCR "can61"
bam_partial_dependence(species = species_v5[1], bcr = bcraoi_v5[1], 
...
# BCR "can80"
bam_partial_dependence(species = species_v5[1], bcr = bcraoi_v5[2], 
                       predictor = "SCANFIprcD_1km", version = "v5", spar=0.4)
