...
- `version`: A `character`, either `"v4"` or `"v5"`. Defaults to `"v5"`. 
Note: as of Februrary 21, 2026 only version 5 data is available. We're working to provide version 4 functionality as soon as we can!
...
Looks like time and landcover are slightly more important in BCR 80 than BCR 61.
