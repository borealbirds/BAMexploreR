...
plot(result_sub$CAWA$mean)
plot(result_sub$OSFL$mean)
```
...
Let's imagine a regional planning project where we need to know which BCR (in our AOI) has a larger Canada Warbler population. We might start by creating a new SpatVector with separate polygons for the two BCRs in our AOI.
