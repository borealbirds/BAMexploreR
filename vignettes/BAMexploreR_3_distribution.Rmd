...
Let's say we're doign regional planning and we're interested in which region has a larger Olive-sided Flycatcher population. Let's try grouping by bird conservation region (BCR; i.e.,our model subregions). First we'll need to create a new SpatVector with separate polygons for the two BCRs in our AOI.
