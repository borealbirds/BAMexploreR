...
```{r get_layer_code, echo = FALSE, message=FALSE, results='hide'}
...
#Download the model products
result <- bam_get_layer("OSFL", "v5", destfile = tempdir(), year = "2020", bcrNM=bcraoi_v5)
```

The output of the function is a list of SpatRaster objects. Each object of the version 5 models has two bands:
...
Finally, we can plot these bands for one of our species of interest! Let's try Olive-sided Flycatcher.
