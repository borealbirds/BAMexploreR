...
test_that("bam_predictor_barchart handles filtering by species", {
  result <- bam_predictor_barchart(species = "ALFL", groups = c("spp", "predictor_class"), plot = FALSE)
...
test_that("bam_predictor_barchart produces a ggplot object when plot = TRUE", {
  result <- bam_predictor_barchart(groups = c("predictor_class", "bcr"), plot = TRUE)
...
test_that("bam_predictor_barchart throws error if groups input is missing", {
  expect_error(bam_predictor_barchart(groups = c("predictor_class", "bcrs"), plot = FALSE))
})


# Test that if groups input is missing
test_that("bam_predictor_barchart throws error if groups input is missing", {
  expect_error(bam_predictor_barchart(groups = "predictor_class", plot = FALSE))
})
