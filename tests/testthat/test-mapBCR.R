...
test_that("mapBCR handles case-sensitive and whitespace issues with version input", {
  expect_error(mapBCR(" V4 "), "Invalid version argument. Must be either 'v4' or 'v5'.")
  expect_error(mapBCR("v 4"), "Invalid version argument. Must be either 'v4' or 'v5'.")
  expect_error(mapBCR(version = "invalid_version"), "Invalid version argument. Must be either 'v4' or 'v5'.")
})
...
test_that("mapBCR warns if ext does not intersect base BCRs", {
  ...
  expect_warning(
    mapBCR(version = "v4", ext = non_intersecting_vect),
